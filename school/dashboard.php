                                            ...
                                            <div class="panel panel-default">
                                                <div class="panel-body bk-success text-light">
                                                    <div class="stat-panel text-center">
                                                        <?php
                                                        $aid = $_SESSION['id'];
                                                        $result1 = "SELECT count(*) FROM admin";
                                                        ...
                                                        <div class="stat-panel-title text-uppercase">Total Landlord </div>
                                                    </div>
                                                </div>
                                                <a href="landload.php" class="block-anchor panel-footer text-center">See All &nbsp; <i class="fa fa-arrow-right"></i></a>
                                            </div>
                                        </div>
