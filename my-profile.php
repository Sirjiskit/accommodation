...
if(isset($_POST['update']))
{
 ...
 $img = $_FILES['img']['name'];
   if(!empty($img)){
				move_uploaded_file($_FILES['img']['tmp_name'], './user_images/'.$img);
				$filename = $img;	
			}
			else{
		   $aid=$_SESSION['id'];
...
$query="update  userRegistration set img=?,contactNo=?,updationDate=? where id=?";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('sssi',$filename,$contactno,$udate,$student_id);
$stmt->execute();
...
<div class="col-sm-8">
<input type="text" name="regno" id="regno"  class="form-control" required="required" value="<?php echo $row->admission_no;?>" disabled>
</div>
</div>
...
<div class="col-sm-8">
<input type="text" name="Department" id="Department"  class="form-control" required="required" value="<?php echo $row->department;?>" disabled>
</div>
</div>
...
<div class="col-sm-8">
<input type="text" name="Level" id="Level"  class="form-control" required="required" value="<?php echo $row->level;?>" disabled>
</div>
</div>
...
<div class="col-sm-8">
<input type="text" name="mname" id="mname"  class="form-control" value="<?php echo $row->middleName;?>"  disabled>
</div>
</div>
...
<div class="col-sm-8">
<select name="gender" class="form-control" required="required" disabled>
...
<div class="col-sm-8">
<input type= "file"  name="img" id="img" class="form-control" accept="image/x-png,image/gif,image/jpeg"> 
</div>
</div>
