...
<?php 
 $ret= mysqli_query($mysqli,"SELECT * FROM userregistration where id = '".$_SESSION['id']."'");
										...
										<div class="panel panel-default">
											<div class="panel-body bk-primary text-light">
												<div class="stat-panel text-center">
													...
													<div class="stat-panel-number h1 ">My Pr<img src="./user_images/<?php echo $img;?>" style="border-radius:50px; border:3px solid white;" height="35" width="35">file</div>
